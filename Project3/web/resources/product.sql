...
Insert into Product values(null, "Softball", 8, "19.99", "Fluorescent yellow", "Softball is a variant of baseball played with a larger ball on a smaller field. For slow-pitch softball, a team of 10 players take turn hitting and catching. For fast-pitch softball, the pitch is faster and there are nine players on the file d at one time.", "Spherical", "11-12 in", "6.25-7 oz (178198.4 g)", "Cork and rubber", "softball.png");
